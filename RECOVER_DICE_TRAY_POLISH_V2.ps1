...
# Always install the corrected helper. This also fixes the previous
# trayRoot.lossyScale compile mistake.
...
Write-Host "SUCCESS - DICE POLISH RECOVERY V2 VERIFIED"
Write-Host ""
