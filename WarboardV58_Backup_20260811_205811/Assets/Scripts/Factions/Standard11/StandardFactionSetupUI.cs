...
/// Source-derived rule text comes from the JSON faction packs. v47 layers
/// generic bearer, target-state, marker, choice and special-placement engines
/// over the v46 deterministic hooks; unsupported edge cases remain explicit.
/// </summary>
[DefaultExecutionOrder(-31970)]
public sealed partial class StandardFactionSetupUI :
    MonoBehaviour
{
            ...
            stratagem)
    {
        ...
        if (WarboardV47StratagemAutomation.TryUse(
                controller,
                stratagem))
        {
            return;
        ...
        game.StandardLog(
            ...
            ". CP spent. Any interaction not yet represented by a deterministic v47 hook remains player-resolved."
        );
