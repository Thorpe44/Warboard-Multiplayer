...
public static class WarboardFactionExtensionHub
{
        ...
        UniversalAttackRuleState state)
    {
        ...
        WarboardAttackAugment47 v47 =
            WarboardV47FactionRules.BuildAttackAugment(
                game,
                attacker,
                target,
                shooter,
        ...
        foreach (string note in v47.Notes)
        {
        ...
        string ruleName)
    {
        ...
        if (WarboardV47FactionRules.GrantsCoreAbility(
                unit,
                ruleName))
        {
            return true;
    ...
    public static int
        ConditionalFeelNoPain(
            ...
            int existing)
    {
        return WarboardV47FactionRules
            .ConditionalFeelNoPain(
                unit,
                label,
                existing
    ...
    public static int AdditionalAttacks(
        ...
        AttackMode mode)
    {
        // Compatibility overload for older call sites. New combat paths use
        // the model-aware overload below so bearer-only Enhancements cannot
        // leak to every model in an Attached unit.
        return BaseAdditionalAttacks(
            attacker,
            weapon,
            mode
        ) +
    ...
    public static int AdditionalAttacks(
        ...
        AttackMode mode)
    {
        WarboardAttackAugment47 augment =
            WarboardV47FactionRules
                .BuildAttackAugment(
                    game,
                    attacker,
        ...
        augment.AdditionalAttacks;
    }

    private static int BaseAdditionalAttacks(
        SquadController attacker,
        WeaponData weapon,
        AttackMode mode)
    {
    ...
    private static int BaseMinimumSustainedHits(
        SquadController attacker,
        SquadController target,
        WeaponData weapon,
        AttackMode mode)
    ...
    private static bool BaseGrantsLethalHits(
        SquadController attacker,
        SquadController target,
        WeaponData weapon,
        AttackMode mode)
    ...
    private static bool BaseGrantsDevastatingWounds(
        SquadController attacker,
        SquadController target,
        WeaponData weapon,
        AttackMode mode)
    ...
    private static bool BaseGrantsPrecision(
        SquadController attacker,
        SquadController target,
        WeaponData weapon,
        AttackMode mode)
    {
        // Pool-wide Precision remains false here for effects such as Hive
        // Predators. v47 handles those through GrantsPrecisionOnCriticalHit
        // and the per-die provenance layer instead of over-applying Precision.
        return false;
    }

    public static bool GrantsPrecisionOnCriticalHit(
        SquadController attacker,
        SquadController target,
        WeaponData weapon,
        AttackMode mode)
    ...
    private static bool BaseRerollHitOnes(
        GameController game,
        SquadController attacker,
        SquadController target,
        WeaponData weapon,
    ...
    private static bool BaseRerollAllHits(
        GameController game,
        SquadController attacker,
        SquadController target,
        WeaponData weapon,
    ...
    private static bool BaseRerollWoundOnes(
        GameController game,
        SquadController attacker,
        SquadController target,
        WeaponData weapon,
    ...
    private static bool BaseRerollAllWounds(
        GameController game,
        SquadController attacker,
        SquadController target,
        WeaponData weapon,
    ...
    private static int BaseChargeRollModifier(
        GameController game,
        SquadController attacker,
        SquadController target)
    {
    ...
    private static float BaseMoveModifier(
        GameController game,
        SquadController unit)
    {
        StandardFactionGameController c =
        ...
        SquadController target)
    {
                ...
                .ApplicableToUnit(target))
        {
            ...
            if (enhancement ==
                    StandardFactionPack11.Normalize(
                        "CRYPTOPHOTAIC CAMOUFLAGE UPGRADE") ||
                rule.Contains(
