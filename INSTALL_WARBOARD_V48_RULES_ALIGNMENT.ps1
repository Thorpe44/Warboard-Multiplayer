...
try {
    ...
    if ($buildText -notmatch 'Version\s*=\s*"v47"') {
        Fail 'This patch expects a working v47 project. WarboardBuildInfo.cs is not v47.'
    }
    ...
    Write-Host "Warboard v48 - 11th Edition Rules Alignment" -ForegroundColor Cyan
    ...
    # 2) Build label.
    Replace-Exact $buildPath 'public const string Version = "v47";' 'public const string Version = "v48";' 'build version'
    Replace-Exact $buildPath 'public const string Label = "11th Edition Full Faction Rules";' 'public const string Label = "11th Edition Rules Alignment";' 'build label'
